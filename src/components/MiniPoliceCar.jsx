...
const MiniPoliceCar = () => {
    ...
    const miniPoliceCar = toyData.filter(sp => sp.sub_category === 'Mini Police Car')

    return (
        <div className="px-2 lg:px-0">
            <h2 className="text-2xl font-bold text-[#ffc800] py-4">Mini Police Car</h2>
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {miniPoliceCar.map((toy) => (
